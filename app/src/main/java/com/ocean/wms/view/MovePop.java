...
public class MovePop {
    ...
    public MovePop(Activity context) {
     ...
     * @param adapter
     */
    public  void showView(final View v, ArrayAdapter adapter, final OnMoveSelectedListener listener) {
        ...
        // 我觉得这里是API的一个bug
        popupWindow.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.layout_bg_my_value));
